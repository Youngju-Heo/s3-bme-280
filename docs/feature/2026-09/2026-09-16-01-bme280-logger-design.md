...
| 센서 연결 | SPI2, 모드 0, 1MHz, SCK=GPIO3 / MOSI=GPIO4 / CS=GPIO5 / MISO=GPIO6 | 사용자 요청(SPI 테스트). BME280 모듈 핀 순서(SCL, SDA, CSB, SDO)에 1:1 대응하도록 GND/3V3 쪽 헤더의 연속 핀 사용. GPIO 매트릭스 경유이나 1MHz에서는 무관. 점퍼선 배선을 고려해 보수적인 클럭 |
